  ...
  useEffect(() => {
    ...
    const fetchPosts = async () => {
      const res = username
        ...
        : await axios.get("posts/timeline/" + user._id); //ovo sluzi da prikaze postove samo onih korisnika koje korisnik prati ukljucujuci logiku iz Post.jsx sa dodatim PF env-om
      setPosts(
