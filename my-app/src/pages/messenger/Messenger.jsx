...
const Messenger = () => {
  ...
  useEffect(() => {
    arrivalMessage &&
      currentChat?.members.includes(arrivalMessage.sender) && //ako je arrivalMessage
  ...
  useEffect(() => {
    const getConversations = async () => {
      try {
        const res = await axios.get("/chattings/" + user._id);
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const res = await axios.post("/messages", message); // , message znaci sending
